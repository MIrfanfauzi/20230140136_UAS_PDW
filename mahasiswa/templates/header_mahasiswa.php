...
<body class="bg-yellow-50 font-sans">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <?php 
                                // Menyiapkan class untuk link aktif dan tidak aktif dengan tema kuning
                                $activeClass = 'bg-yellow-900 text-yellow-100';
                                $inactiveClass = 'text-yellow-100 hover:bg-yellow-800 hover:text-white';
                            ?>
                            ...
                            <a href="detail_praktikum.php?id=1" class="<?php echo ($activePage == 'lihat detail') ? $activeClass : $inactiveClass; ?> px-3 py-2 rounded-md text-sm font-medium">Detail Praktikum</a>
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        <a href="../logout.php" class="bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded-md transition-colors duration-300">
                            Logout
                        </a>
                    </div>
                </div>
    ...
    <main class="container mx-auto p-6 lg:p-8"></main>